...
| --- | --- | --- | --- |
| Windows 10/11 x64 | `CoreCare-win-Setup.exe` | `0.1.0-beta.90` | Velopack installer with automatic updates. The current beta is unsigned, so Windows may show a publisher warning. |
| Linux x64 | `CoreCare.AppImage` | `0.1.0-beta.96-linux` | Self-contained AppImage with a dedicated Linux update channel. |
